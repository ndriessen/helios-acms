...
public final class ManagedConfigurationMixin {
    ...
    public static void registerMixin(Session session) throws ManagedConfigurationException {
        try {
            ...
            throw new ManagedConfigurationException("Error registering custom mixin type. Configuration management will not work!", e);
        }
    }
}
