...
public class PlaceHolderAwareNode {
     ...
     * @throws ManagedConfigurationException When placeholder resolution fails.
     */
    public boolean resolvePlaceholders(Properties properties) throws ManagedConfigurationException {
        try {
            ...
            while (nodeProperties.hasNext()) {
                ...
                try {
                    ...
                    throw new ManagedConfigurationException("Error while trying to resolve placeholders in node '{}', property '{}'", e, nodePath, property.getName());
                }
            }
            ...
            throw new ManagedConfigurationException("Error while resolving placeholders in node '%s'", e, this.nodePath);
        }
    }
